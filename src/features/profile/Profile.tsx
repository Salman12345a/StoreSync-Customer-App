...
const Profile: FC = () => {
  ...
  const renderHeader = () => {
    return (
      <View>
        <CustomTextLeft varient="h3" fontFamily={Fonts.SemiBold}>
          Your account
        </CustomTextLeft>
        <CustomTextLeft varient="h7" fontFamily={Fonts.Medium}>
          {user?.phone}
        </CustomTextLeft>
        <WalletSection />
        <CustomTextLeft varient="h8" style={styles.informativeText}>
          YOUR INFORMATION
        </CustomTextLeft>
        ...
        <CustomTextLeft varient="h8" style={styles.pastText}>
          PAST ORDERS
        </CustomTextLeft>
      </View>
    );
